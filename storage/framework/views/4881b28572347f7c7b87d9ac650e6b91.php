    ...
    <div class="menu">
        ...
        <a href="javascript:void(0);" class="menu-profile-link" data-toggle="app-sidebar-profile" data-target="#appSidebarProfileMenu">
          ...
          <div class="menu-profile-info">
            <div class="d-flex align-items-center">
              <div class="flex-grow-1"><?php echo e($memberInfo['name']); ?> <span style='font-size:9px;'>님</span></div>
      ...
      <div class="depth1" data-selector="depth1" data-sid="0">
        ...
        <div class="menu-item" data-selector="depth2" data-sid="1">
          <a href="<?php echo e(route('management.mian')); ?>" class="menu-link">
            <div class="menu-icon">
...
<?php /**PATH /Users/happyoley/develop/onnuri/resources/views/management/navbars/sidenav.blade.php ENDPATH**/ ?>