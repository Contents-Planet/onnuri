var app = {
  ...
  var t = new Date, s = t.getTime() + 36e6;
  ...
  if (!(e.scrollbarInit || app.isMobile && e.getAttribute(app.scrollBar.skipMobileAttr))) {
    ...
    if (e.style.height = a, e.scrollbarInit = !0, app.isMobile) e.style.overflowX = "scroll"; else {
      var t = !!e.getAttribute(app.scrollBar.wheelPropagationAttr) && e.getAttribute(app.scrollBar.wheelPropagationAttr);
      e.closest("." + app.sidebar.class + ":not(." + app.sidebarEnd.class + ")") && 0 !== e.closest("." + app.sidebar.class + ":not(." + app.sidebarEnd.class + ")").length ? app.sidebar.scrollBar.dom = new PerfectScrollbar(e, {wheelPropagation: t}) : new PerfectScrollbar(e, {wheelPropagation: t})
    }
  }
  ...
  var e = document.querySelector("." + app.sidebar.class + ":not(." + app.sidebarEnd.class + ")"),
    ...
    l = t + " > ." + app.sidebar.menu.itemLinkClass, o = [].slice.call(document.querySelectorAll(l));
  o && handleSidebarMenuToggle(o, a);
  var r = t + s, n = [].slice.call(document.querySelectorAll(r + " > ." + app.sidebar.menu.itemLinkClass));
  n && handleSidebarMenuToggle(n, a);
  var i = t + s + s, p = [].slice.call(document.querySelectorAll(i + " > ." + app.sidebar.menu.itemLinkClass));
  ...
  [].slice.call(document.querySelectorAll("[" + app.sidebar.minify.toggleAttr + "]")).map((function (e) {
    e.onclick = function (e) {
      e.preventDefault();
      var a = document.querySelector("." + app.class).classList, t = !1;
  ...
  [].slice.call(document.querySelectorAll("[" + app.panel.toggle.remove.attr + "]")).map((function (a) {
    ...
    a.onmouseover = function (a) {
      ...
      if (!t.classList.contains(app.panel.loadingClass)) {
        var s = t.querySelector("." + app.panel.bodyClass), l = document.createElement("div");
    ...
    a.onmouseover = function () {
      ...
      a.preventDefault(), e && e.hide();
      var t = this.closest("." + app.panel.class), s = t.querySelector("." + app.panel.bodyClass);
      if (s) {
        var l = t.offsetTop;
        s.offsetTop - l
      }
  ...
  if (jQuery) {
    var e = $("." + app.panel.class + ":not([" + app.panel.draggable.disableAttr + "])").parent("[class*=col]"),
      a = "." + app.panel.headClass, t = app.panel.draggable.connectedTarget;
    $(e).sortable({
  ...
  ((a = document.querySelector("[" + app.themePanel.toggleAttr + "]")) && (a.onclick = function (e) {
    e.preventDefault();
    var a = document.querySelector("." + app.themePanel.class), t = !a.classList.contains(app.themePanel.activeClass);
  ...
  function e(e, a) {
    var t = e.closest("." + app.unlimitedTabs.class), s = window.getComputedStyle(document.body),
      ...
      r = parseInt(l.getPropertyValue(o)), n = t.clientWidth, i = 0, p = [].slice.call(t.querySelectorAll("li"));
    ...
    e && e.map((function (e) {
      !function (e, a) {
        ...
        var s = window.getComputedStyle(document.querySelector("body")),
          l = "rtl" == s.getPropertyValue("direction") ? "margin-right" : "margin-left", o = window.getComputedStyle(e),
          r = (parseInt(o.getPropertyValue(l)), e.clientWidth),
          n = "object" == typeof t ? t.clientWidth : e.querySelector(t).clientWidth,
          i = a > -1 ? a : app.animation.speed, p = 0,
          c = [].slice.call(e.querySelectorAll("." + app.bootstrap.nav.tabs.itemClass)), d = !1;
  ...
  function e(e, a) {
    var t = e.closest("." + app.topMenu.menu.class), s = window.getComputedStyle(t),
      ...
      i = 0, p = 0, c = t.querySelector(".menu-control-start"), d = c ? c.clientWidth : 0,
      u = t.querySelector(".menu-control-end"), m = d + (c ? u.clientWidth : 0),
  ...
  function a() {
    ...
    if (e) {
      var a = window.getComputedStyle(e), t = window.getComputedStyle(document.body),
        s = "rtl" == t.getPropertyValue("direction") ? "margin-right" : "margin-left",
        l = (parseInt(a.getPropertyValue(s)), document.querySelector("." + app.topMenu.class).clientWidth), o = 0,
        r = 0, n = e.querySelector(".menu-control-start"),
        i = (n && n.clientWidth, e.querySelector(".menu-control-end")), p = n ? i.clientWidth : 0, c = 0,
  ...
  function s(e) {
    ...
    if (!a) return;
    const t = a.querySelector(".menu"), s = t.querySelectorAll(".menu-item:not(.menu-control)");
    let l, o, r, n = 0, i = 0;
    s.forEach((e => {
      n += e.offsetWidth
  ...
  var e = "." + app.topMenu.class + " ." + app.topMenu.menu.class + " > ." + app.topMenu.menu.itemClass + "." + app.topMenu.menu.hasSubClass,
    ...
    t = e + " > ." + app.topMenu.menu.itemLinkClass, s = [].slice.call(document.querySelectorAll(t));
  handleTopMenuToggle(s, !0);
  var l = e + a, o = [].slice.call(document.querySelectorAll(l + " > ." + app.topMenu.menu.itemLinkClass));
  handleTopMenuToggle(o);
  var r = e + a + a, n = [].slice.call(document.querySelectorAll(r + " > ." + app.topMenu.menu.itemLinkClass));
  ...
  e && e.map((function (e) {
    e.onclick = function (e) {
      ...
      var a = this.closest("." + app.sidebar.menu.itemClass).querySelector("." + app.sidebar.menu.submenu.class),
        t = getComputedStyle(a), s = "none" != t.getPropertyValue("display"),
      ...
      var o = setInterval((function () {
        var e = document.querySelector(app.sidebar.floatSubmenu.id),
          ...
          t = document.querySelector(app.sidebar.floatSubmenu.line.id), o = e.clientHeight,
          r = e.getBoundingClientRect(), n = e.getAttribute("data-offset-top"),
          i = e.getAttribute("data-menu-offset-top"), p = r.top, c = document.body.clientHeight;
      ...
      if (e && e.classList.contains(app.sidebar.minify.toggledClass)) {
        ...
        if (t) {
          var s = getComputedStyle(document.body), l = document.querySelector(app.sidebar.id),
            ...
            i = handleGetHiddenMenuHeight(a), p = this.getBoundingClientRect().top,
            ...
            u = l.getAttribute(app.darkMode.attr) == app.darkMode.value, m = document.body.clientHeight;
          ...
          if (m - p > i) g && (g.style.top = p + "px", g.style.left = c + "px", g.style.bottom = "auto", g.style.right = d + "px"), C && (C.style.top = "20px", C.style.bottom = "auto"), L && (L.style.top = "20px", L.style.bottom = "auto"); else {
            var A = m - p - 21;
            g && (g.style.top = "auto", g.style.left = c + "px", g.style.bottom = 0, g.style.right = d + "px"), C && (C.style.top = "auto", C.style.bottom = A + "px"), L && (L.style.top = "20px", L.style.bottom = A + "px")
          }
  ...
  return {
    emptyHtml: "", init: function (a) {
      ...
      var a = e.replace("#", ""), t = window.navigator.userAgent.indexOf("MSIE ");
      ...
      if (e) {
        ...
        var t;
        if (!document.querySelector(app.ajax.loader.id)) if (document.body.classList.add(app.ajax.loader.class), t = document.querySelector("." + app.content.class)) {
      ...
      if (l) {
        var o = a.replace("#", ""), r = e && e.ajaxType ? e.ajaxType : "GET",
  ...
  if (a) {
    ...
    if (e.appHeaderInverse) (s = document.querySelector("." + app.header.class)) && s.classList.add(app.header.inverse.class);
  ...
  if (a) {
    ...
    if (e.appHeaderInverse) (s = document.querySelector("." + app.header.class)) && s.classList.remove(app.header.inverse.class);
  ...
  e && e.map((function (e) {
    var a = e.getAttribute(app.animation.attr), t = e.getAttribute(app.animation.valueAttr);
    switch (a) {
      case"width":
        e.style.width = t;
        break;
      ...
      case"number":
        ...
        const a = () => {
          const e = +t.replace(",", ""), o = +(s.count ? s.count : 0), r = e / app.animation.speed;
          if (o < e) {
            var n = o + r;
  ...
  e && e.map((function (e) {
    e.onclick = function (e) {
      ...
      var a = this.getAttribute(app.toggleClass.targetAttr) ? this.getAttribute(app.toggleClass.targetAttr) : "",
        t = this.getAttribute(app.toggleClass.toggleAttr), s = document.querySelector(a);
  ...
  e && e.map((function (e) {
    e.onclick = function (e) {
      ...
      var a = this.getAttribute(app.dismissClass.targetAttr) ? this.getAttribute(app.dismissClass.targetAttr) : "",
        t = this.getAttribute(app.dismissClass.toggleAttr), s = document.querySelector(a);
